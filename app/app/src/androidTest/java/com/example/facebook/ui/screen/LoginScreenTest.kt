...
class LoginScreenTest {
    ...
    fun testLoginScreenDisplaysCorrectly() {
        ...
        composeTestRule.onNodeWithText("Địa chỉ Email").assertExists().assertIsDisplayed()
        ...
        composeTestRule.onNodeWithText("Quên mật khẩu?").assertExists().assertIsDisplayed()
